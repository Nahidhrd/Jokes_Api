package com.example.jokesapidemo.apicall
...
interface JokesApiService {
    ...
    @GET("joke/{category}")
    suspend fun getJokes (@Path("category") category: String): Response<ResponseJokes>
...
object JokesClient {
    ...
    val JokesApiService = retrofit.create(com.example.jokesapidemo.apicall.JokesApiService::class.java)
